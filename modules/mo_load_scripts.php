...
function myScripts() {  
    wp_enqueue_script( 'sign', get_template_directory_uri() . '/js/sign.js', array( 'jquery' ), THEME_VERSION, true );
   if(_hui('the_wow_s')){ wp_enqueue_script( 'wow', 'https://lib.baomitu.com/wow/1.0.1/wow.min.js', array( 'jquery' ), THEME_VERSION, true );
      wp_enqueue_style( 'animate', get_template_directory_uri() . '/css/wow.css' ); } 
	 if(_hui('lightbox_s')){ wp_enqueue_script( 'Lightbox', get_template_directory_uri() . '/js/Lightbox.js', array( 'jquery' ), THEME_VERSION, true ); }
      wp_enqueue_script( 'cookie', get_template_directory_uri() . '/js/libs/jquery.cookie.js', array( 'jquery' ), THEME_VERSION, true );
}  

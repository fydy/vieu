		   ...
		   echo'<div class="wel">';
			 if( is_user_logged_in() ): global $current_user;
				...
				if( _hui('user_page_s') ){
					...
					<li><a href="/wp-admin/profile.php">详细资料</a></li><li><a href="'.mo_get_user_page().'#pay">我的订单</a></li>';
					if( is_super_admin() ){ 
		...
		if( _hui('m_navbar') ){ 
		 if( is_user_logged_in() ){
				...
				<div class="m-wel-content">
					<ul>					
					    <li><a href="'. mo_get_user_page().'#index">用户中心</a></li>
					    <li><a href="'. mo_get_user_page().'#pay">我的订单</a></li>

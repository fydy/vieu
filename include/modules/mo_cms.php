...
<div class="catlist-<?php echo $catid;?> cat-container clearfix">
        <h2 class="home-heading clearfix">
            <span class="heading-text<?php echo get_wow_1(); ?>"><?php echo $catname;?></span><a <?php echo _post_target_blank();?> href="<?php echo $catlink;?>">更多 <i class="fa fa-plus-circle"></i> </a>
        </h2>
        <div class="cms-cat cms-cat-s<?php echo substr($tp,-1);?>">
        <?php get_template_part('include/cms/'.$tp,esc_attr( $catid ));?>	
        </div>                            
</div>	
<?php $m=0; }else{ $m++;?>
<?php if($m==1) { ?>
...
<div class="catlist-<?php echo $catid;?> cat-col-1_2">
    <div class="cat-container clearfix">
        ...
        <div class="cms-cat cms-cat-s<?php echo substr($tp,-1);?>">
        <?php get_template_part('include/cms/catlist_bar_0',esc_attr( $catid ));?>	
        </div>  
    </div>		
</div>
<?php }?>	

...
class widget_ui_links extends WP_Widget {


	function __construct(){
		parent::__construct( 'widget_ui_links', 'Vi-友情链接', array( 'classname' => 'widget_ui_links'.get_wow_3().'' ) );
	}
	...
	function widget( $args, $instance ) {
		...
		if(_hui('gd_links')){echo '<a href="'._hui('gd_links').'" class="widget_links_gduo'.get_wow_3().'">更多>></a>';}
